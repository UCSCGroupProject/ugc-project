...
// Staff views
//Admin
const Adm_Authorize_StaffRegistration = React.lazy(() =>
  import('./views/staff/admin/StaffRegistration'),
)
...
const Staff_AptitudeTests_Upcoming = React.lazy(() =>
  import('./views/staff/aptitudeTests/Upcoming'),
)
...
const Staff_Achievement_Validation = React.lazy(() =>
...
const Stu_StudentDetails_Settings = React.lazy(() =>
  import('./views/student/settings/StudentDetails_Settings'),
)
const Stu_LoginDetails_Settings = React.lazy(() =>
...
const Stu_Courses_CourseDetails_RecommendedCourses = React.lazy(() =>
  import('./views/student/courses/courseDetails/RecommendedCourses'),
)
const Stu_Courses_CourseDetails_AllCourses = React.lazy(() =>
  import('./views/student/courses/courseDetails/AllCourses'),
)
const Stu_University_UniversityDetails_AllUniversities = React.lazy(() =>
  import('./views/student/university/universityDetails/AllUniversities'),
)
const Stu_University_UniversityDetails_Profile = React.lazy(() =>
  import('./views/student/university/universityDetails/UniversityProfile'),
)
const Stu_AptitudeTests_TestDetails_MyTests = React.lazy(() =>
  import('./views/student/aptitudeTests/testDetails/MyTests'),
)
const Stu_AptitudeTests_TestDetails_Results = React.lazy(() =>
  import('./views/student/aptitudeTests/testDetails/Results'),
)
const Stu_AptitudeTests_TestDetails_Progress = React.lazy(() =>
  import('./views/student/aptitudeTests/testDetails/Progress'),
)
...
const routes = [
  ...
  {
    path: '/staff/aptitudetests/upcoming',
    name: 'Upcoming Tests',
    element: Staff_AptitudeTests_Upcoming,
  },
  {
    path: '/staff/aptitudetests/completed',
  ...
  { path: '/staff/eligible', name: 'Eligible Students', element: Staff_Eligible },
  { path: '/staff/eligible/courses', name: 'Eligible Students', element: Staff_Eligible_Courses },
  { path: '/staff/eligible/course/students', name: 'Eligible Students', element: Staff_Eligible_Students },
  ...
  {
    path: '/staff/validation/achievement',
  ...
  {
    path: '/student/aptitudetests/results',
    name: 'Results',
    element: Stu_AptitudeTests_TestDetails_Results,
  },
  {
    path: '/student/aptitudetests/progress',
    name: 'Progress',
