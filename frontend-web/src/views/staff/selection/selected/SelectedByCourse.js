          ...
          <CCard className="mb-4">
            ...
            <CCardBody>
              <CNav variant="tabs" role="tablist">
                ...
                <CNavItem>
                  <NavLink
                    to="/staff/selected/filterbyUniversity"
                                  ...
                                  <CTableRow key={item.id}>
                                    ...
                                    <CTableDataCell>
                                      <CButton
                                        color="warning"
                                        component="a"
                                        href={`/staff/selected/filterbyCourse/unicode?course=${item[0]}`}
                                      >
                                        View More
                                      </CButton>
                                    </CTableDataCell>
...
export default SelectedByCourse
